...
function fetchCoinImages(nickname) { // Тепер ця функція синхронна, бо не робить await запитів
    ...
    const baseUrl = 'media/coin_images/'; // !!! ВИКОРИСТОВУЙТЕ ЗВИЧАЙНІ ЛАПКИ ТУТ !!!
    ...
    if (nickname && typeof nickname === 'string' && nickname.trim() !== '') {
        ...
        // Переконайтесь, що використовуєте ЗВОРОТНІ лапки (`) навколо всього рядка
    ...
    // Перевіряємо, чи були сформовані потенційні кастомні шляхи (тобто чи був вказаний нікнейм)
    if (potentialCustomSide1 && potentialCustomSide2) {
         ...
         // Тут вже finalSideUrl залишаються дефолтними, як були ініціалізовані
    }
